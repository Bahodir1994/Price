...
@Entity
@Table(name = "UNIT", schema = "CPID")
@Where(clause = "USE_YN = 'Y'")
@IdClass(UnitPK.class)
public class Unit {
    @Id
    ...
    @Column(name = "CD_DESC", columnDefinition = "VARCHAR(150) CCSID 1208")
    String cdDesc;

    @Column(name = "CD_ID_L", columnDefinition = "VARCHAR(3) CCSID 1025")
    String cdIdL;

    @Column(name = "CD_NM", columnDefinition = "VARCHAR(150) CCSID 1208")
    String cdNm;
    ...
    public Unit(String code, String cdDesc, String cdId, String cdIdL, String cdNm, String cdOrdr, String lngaTpcd, String useYN) {
        this.code = code;
        this.cdDesc = cdDesc;
        this.cdId = cdId;
        this.cdIdL = cdIdL;
