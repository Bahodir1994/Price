...
@Entity
@Table(name = "FEAT_MOVE", schema = "CPID")
@Where(clause = "USE_YN = 'Y'")
@IdClass(FeatMovePK.class)
public class FeatMove {
    @Id
    ...
    public FeatMove(String code, String cdDesc, String cdId, String cdIdL, String cdNm, String cdOrdr, String lngaTpcd, String useYN) {
        this.code = code;
        this.cdDesc = cdDesc;
        this.cdId = cdId;
        this.cdIdL = cdIdL;
