...
<div class="page-wrapper" id="container">
                ...
                <div class="col-sm-12 my-0 py-0 px-0 " style="vertical-align: middle">
                    <div class="justify-content-center py-1 pb-2 mt-2">
                        <div class="form-row m-0 justify-content-center">
                            <div class="form-group col-xl-1 mx-2  p-0 text-center" data-tg-tour="Step 1"
                                 data-tg-title="Example heading 1">
                                <label for="g33" class="f-w-600" style=" margin-right: 5px;"><fmt:message key="hsCode"
                                                                                                          bundle="${resourceBundle}"/></label>
                                <input type="text" id="g33" class="form-control form-control-sm w-100 g33"
                                       placeholder="0000 00 000 0">
                            </div>
                            <div class="form-group col-xl-1 mx-2  p-0 text-center" data-tg-tour="Step 2"
                                 data-tg-title="Example heading 2">
                                <label for="g31Name" class="f-w-600" style=" margin-right: 5px;"><fmt:message
                                        key="commodityName" bundle="${resourceBundle}"/></label>
                                <input type="text" id="g31Name" class="form-control form-control-sm w-100 g31Name"
                                       placeholder="BYD">
                            </div>
                            <div class="form-group col-xl-2 mr-2  p-0 text-center" data-tg-tour="Step 3"
                                 data-tg-title="Example heading 3">
                                <label for="g15" class="f-w-600" style=" margin-right: 5px;"><fmt:message
                                        key="shipmentCountry" bundle="${resourceBundle}"/></label>
                            ...
                            <div class="form-group col-xl-2 col-sm-2 mr-2  p-0 text-center">
                                <label for="g11" class="f-w-600" style=" margin-right: 5px;"><fmt:message
                                        key="originCountry" bundle="${resourceBundle}"/></label>
                            ...
                            <div class="form-group col-xl-1 text-right m-0 p-0 mr-1">
                                <label for="gc3DateStart"
                                       class="f-w-600"
                                       style=" margin-right: 5px;"><fmt:message key="from"
                                                                                bundle="${resourceBundle}"/>: </label>
                                <input type="date" class="form-control form-control-sm w-100 gc3DateStart"
                                       maxlength="10" tabindex="1" name="dcodate" id="gc3DateStart">
                            </div>
                            <div class="form-group col-xl-1 col-md-1 col-sm-1 text-right m-0 p-0"><label
                                    for="gc3DateEnd" class="f-w-600" style=" margin-right: 5px;"><fmt:message key="to"
                                                                                                              bundle="${resourceBundle}"/>: </label>
                                <input type="date" class="form-control form-control-sm w-100 gc3DateEnd" maxlength="10"
                                       tabindex="2" name="dcodate" id="gc3DateEnd">
                            </div>
                            <div class="form-group col-xl-1 col-md-1 col-sm-1 text-right ml-1 p-0 "
                                 style="margin-top: 20px">
                                <button type="button" tabindex="3"
                                        class="btn btn-sm btn-outline-primary f-w-900 w-75 updateAppTableV1"
                                        style="border-radius: 5px">
                                    <i class="feather icon-search"></i>&nbsp;<fmt:message key="search"
                            ...
                            <div class="form-group col-xl-1 col-md-1 col-sm-1 text-right ml-1 p-0 "
                                ...
                                <button type="button" tabindex="3"
                                    ...
                                    <i class="feather icon-bar-chart"></i>&nbsp;<fmt:message key="report"
                                                                                             bundle="${resourceBundle}"/>
                                </button>
                            </div>
                            <div class="form-group col-xl-1 col-md-1 col-sm-1 text-right  p-0 "
                                 style="margin-top: 20px">
                                <button type="button" tabindex="3"
                                    ...
                                    <i class="fas fa-wrench"></i> <fmt:message key="configuration"
                                                                               bundle="${resourceBundle}"/>
                                </button>
                            </div>
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <ul class="list-unstyled card-option dropdown-menu dropdown-menu-right" style="">
                                        <li class="dropdown-item full-card" id="toggle_fullscreen"><span style=""><i
                                                class="feather icon-maximize"></i> <fmt:message key="sizeResize"
                                ...
                                <div class="card m-0">
                                    <div class="card-header" id="faqhead2">
                                        <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                                           data-target="#faq2" aria-expanded="true" aria-controls="faq2"><fmt:message
                                                key="additionalSearch" bundle="${resourceBundle}"/></a>
                                    </div>
                                    <div id="faq2" class="collapse" aria-labelledby="faqhead2" data-parent="#faq">
                                        <div class="card-body text-left justify-content-center">
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group col-md-2" data-tg-tour="Step 4"
                                                         data-tg-title="Example heading 4">
                                                        <label for="ugtk"><fmt:message key="regionalCustomsOffice"
                                                                                       bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow ugtk"
                                                            ...
                                                            <c:forEach items="${location}" var="location" varStatus="i">
                                                                <option class="option-class"
                                                                        value="${location.code.substring(2,4)}"
                                                                        data-subtext="${location.code}">${location.cdNm}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="g37C"><fmt:message key="transferFeature"
                                                                                       bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow g37C"
                                                            ...
                                                            <c:forEach items="${featMove}" var="featMove" varStatus="i">
                                                                <option class="option-class"
                                                                        value="${featMove.code}">${featMove.code}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="g41"><fmt:message key="transferFeature"
                                                                                      bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow g41"
                                                            ...
                                                            <c:forEach items="${unit}" var="unit" varStatus="i">
                                                                <option class="option-class"
                                                                        value="${unit.code}">${unit.code}
                                                                    - ${unit.cdDesc}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="g1B"><fmt:message key="customsMode"
                                                                                      bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow g1B"
                                                                ...
                                                                data-selected-text-format="count > 3"
                                                                data-actions-box="true" data-live-search="true">
                                                            <c:forEach items="${customsMode}" var="customsMode"
                                                                       varStatus="i">
                                                                <option class="option-class"
                                                                        value="${customsMode.code}">${customsMode.code}
                                                                    - ${customsMode.cdDesc}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="g20A"><fmt:message key="deliveryCondition"
                                                                                       bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow g20A"
                                                                ...
                                                                data-selected-text-format="count > 3"
                                                                data-actions-box="true" data-live-search="true">
                                                            <c:forEach items="${deliveryTerms}" var="deliveryTerms"
                                                                       varStatus="i">
                                                                <option class="option-class"
                                                                        value="${deliveryTerms.raqam}">${deliveryTerms.raqam}
                                                                    - ${deliveryTerms.sign}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-1">
                                                        <label for="g7BStart"><fmt:message key="ccd"
                                                                                           bundle="${resourceBundle}"/>
                                                    ...
                                                    <div class="form-group col-md-1">
                                                        <label for="g7BEnd"><fmt:message key="ccd"
                                                                                         bundle="${resourceBundle}"/> (:<fmt:message
                                                                key="to" bundle="${resourceBundle}"/>)</label>
                                                        <input type="date"
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="g7A"><fmt:message key="customsPost"
                                                                                      bundle="${resourceBundle}"/> </label>
                                                        <select class="selectpicker form-control show-menu-arrow g7A"
                                                            ...
                                                            <c:forEach items="${post}" var="post" varStatus="i">
                                                                <option class="option-class"
                                                                        value="${post.code}">${post.code}
                                                                    - ${post.cdNm}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="vidKontrakta"><fmt:message key="existenceContract"
                                                                                               bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow vidKontrakta"
                                                                ...
                                                                data-selected-text-format="count > 3"
                                                                data-live-search="true">
                                                            <option class="option-class" value="1"><fmt:message
                                                                    key="yes" bundle="${resourceBundle}"/></option>
                                                            <option class="option-class" value="0"><fmt:message key="no"
                                                                                                                bundle="${resourceBundle}"/></option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="metod"><fmt:message key="method"
                                                                                        bundle="${resourceBundle}"/></label>
                                                        <select class="selectpicker form-control show-menu-arrow metod"
                                                            ...
                                                            <c:forEach items="${method}" var="method" varStatus="i">
                                                                <option class="option-class"
                                                                        value="${method.id}">${method.id.replace('0','')}
                                                                    - усул
                                                                </option>
                                                            </c:forEach>
                                                        </select>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="g37B"><fmt:message key="oldCustomsMode"
                                                                                       bundle="${resourceBundle}"/></label>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="g31Marka"><fmt:message key="brandName"
                                                                                           bundle="${resourceBundle}"/></label>
                                                        <input type="text"
                                                               class="form-control form-control-sm px-1 g31Marka"
                                                               id="g31Marka"
                                                               placeholder="<fmt:message key="brandName" bundle="${resourceBundle}"/>">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="ktd"><fmt:message key="correctionIncluded"
                                                                                      bundle="${resourceBundle}"/></label>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="g7C"><fmt:message key="ccd"
                                                                                      bundle="${resourceBundle}"/>
                                                            <fmt:message key="number"
                                                                         bundle="${resourceBundle}"/></label>
                                                        <input type="text" class="form-control form-control-sm px-1 g7C"
                                                               id="g7C"
                                                               placeholder="<fmt:message key="ccd" bundle="${resourceBundle}"/> <fmt:message key="number" bundle="${resourceBundle}"/>">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="g8Code2"><fmt:message key="importer"
                                                                                          bundle="${resourceBundle}"/>
                                                            <fmt:message key="tin"
                                                                         bundle="${resourceBundle}"/>/<fmt:message
                                                                    key="pin" bundle="${resourceBundle}"/></label>
                                                        <input type="text"
                                                               class="form-control form-control-sm px-1 g8Code2"
                                                               id="g8Code2"
                                                               placeholder="<fmt:message key="tin" bundle="${resourceBundle}"/>/<fmt:message key="pin" bundle="${resourceBundle}"/>">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="g43"><fmt:message key="needOrCommerce"
                                                                                      bundle="${resourceBundle}"/></label>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="idn"><fmt:message key="contractIdnNumber"
                                                                                      bundle="${resourceBundle}"/></label>
                                                        <input type="text" class="form-control form-control-sm px-1 idn"
                                                               id="idn"
                                                               placeholder="<fmt:message key="contractIdnNumber" bundle="${resourceBundle}"/>">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label for="asosQiymat"><fmt:message key="customsValueBasis"
                                                                                             bundle="${resourceBundle}"/></label>
                                                        <input type="text"
                                                               class="form-control form-control-sm px-1 asosQiymat"
                                                               id="asosQiymat"
                                                               placeholder="<fmt:message key="customsValueBasis" bundle="${resourceBundle}"/>">
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        <label><fmt:message key="dateOfBorderCrossing"
                                                                            bundle="${resourceBundle}"/></label>
                                                        <div class="px-1" style="margin-top: -2px">
                                                            <button type="button"
                                                                    class="btn btn-outline-primary btn-sm day30">30
                                                                <fmt:message key="day"
                                                                             bundle="${resourceBundle}"/></button>
                                                            <button type="button"
                                                                    class="btn btn-outline-primary btn-sm day90">90
                                                                <fmt:message key="day"
                                                                             bundle="${resourceBundle}"/></button>
                                                            <button type="button"
                                                                    class="btn btn-outline-primary btn-sm day180">180
                                                                <fmt:message key="day"
                                                                             bundle="${resourceBundle}"/></button>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl modal-autoheight" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #7497ea">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-history text-white"></i>
                            <fmt:message key="reportLable" bundle="${resourceBundle}"/></h5>
                        ...
                        <ul class="nav nav-pills m-auto w-75 justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item w-50 border border-primary rounded-0 text-center"
                                ...
                                <a class="nav-link active rounded-0" id="pills-home-tab" data-toggle="pill"
                                   ...
                                   aria-selected="true"><fmt:message key="lineInspectors"
                            ...
                            <li class="nav-item w-50 border border-primary rounded-0 text-center"
                                ...
                                <a class="nav-link rounded-0" id="pills-profile-tab" data-toggle="pill"
                                   ...
                                   role="tab" aria-controls="pills-profile" aria-selected="false"><fmt:message
                                        key="lineCustoms" bundle="${resourceBundle}"/></a>
                            </li>
                        </ul>
    ...
    <div class="col-12">
        <div class="modal fade" id="columnSetting" tabindex="-1" role="dialog"
             aria-labelledby="columnSettingTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl modal-autoheight" role="document">
...
<%--                                                    <span class="b-title text-muted"><i class="fa fa-history "></i> <fmt:message key="columnSetting"--%>
<%--                                                                                                   bundle="${resourceBundle}"/></span>--%>
<%--                                                </a>--%>
<%--                                            </div>--%>
...
<%--                                                                class="feather icon-search"></i></label>--%>
<%--                                                    </div>--%>
...
<%--                                                        <a class="nav-link text-left active" id="v-pills-home-tab"--%>
...
<%--                                                    </li>--%>
<%--                                                    <li class="nav-item mail-section">--%>
<%--                                                        <a class="nav-link text-left" id="v-pills-starred-tab"--%>
<%--                                                           data-toggle="pill" href="#v-pills-starred" role="tab">--%>
<%--                                                            <span><i class="feather icon-star-on"></i> Starred</span>--%>
<%--                                                        </a>--%>
<%--                                                    </li>--%>
<%--                                                    <li class="nav-item mail-section">--%>
<%--                                                        <a class="nav-link text-left" id="v-pills-messages-tab"--%>
<%--                                                           data-toggle="pill" href="#v-pills-draft" role="tab">--%>
<%--                                                            <span><i class="feather icon-file-text"></i> Drafts</span>--%>
<%--                                                        </a>--%>
<%--                                                    </li>--%>
<%--                                                    <li class="nav-item mail-section">--%>
<%--                                                        <a class="nav-link text-left" id="v-pills-settings-tab"--%>
<%--                                                           data-toggle="pill" href="#v-pills-mail" role="tab">--%>
<%--                                                            <span><i--%>
<%--                                                                    class="feather icon-navigation"></i> Sent Mail</span>--%>
<%--                                                        </a>--%>
<%--                                                    </li>--%>
<%--                                                    <li class="nav-item mail-section">--%>
<%--                                                        <a class="nav-link text-left" id="v-pills-Trash-tab"--%>
<%--                                                           data-toggle="pill" href="#v-pills-Trash" role="tab">--%>
<%--                                                            <span><i class="feather icon-trash-2"></i> Trash</span>--%>
<%--                                                        </a>--%>
<%--                                                    </li>--%>
<%--                                                </ul>--%>
<%--                                                <a class="email-more-link" data-toggle="collapse"--%>
...
<%--                                                            <a class="nav-link text-left">--%>
<%--                                                                <span><i--%>
<%--                                                                        class="feather icon-alert-triangle"></i> Spam</span>--%>
<%--                                                            </a>--%>
<%--                                                        </li>--%>
<%--                                                    </ul>--%>
<%--                                                </div>--%>
...
<%--                                            <!-- [ inbox-left section ] end -->--%>
<%--                                            <!-- [ inbox-right section ] start -->--%>
<%--                                            <div class="col-xl-10 col-md-9 inbox-right appTableV1SettingModal">--%>
...
<%--                        </div>--%>
                    ...
                    <div class="modal-header" style="background-color: #7497ea">
                        <h5 class="modal-title text-white" id="columnSettingLongTitle1"><i class="fa fa-history "></i> <fmt:message
                                key="columnSetting" bundle="${resourceBundle}"/></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-0 dt-responsive p-2">
                <table id="app_table_01" class="table table-striped row-border order-column table-bordered"
    ...
    var app_table_01 = $('#app_table_01').DataTable({
        ...
        columns: [
            ...
            {className: "dt-head-center nowrap", title: appTableV1.g7C, name: 'g7C', data: 'g7C'},
            {
                ...
                title: appTableV1.g7Ag7Bg7C,
                name: 'g7Ag7Bg7C',
                data: 'g7C',
                render: (_, __, row) => {
                    return row.g7A + '/' + row.g7B + '/' + row.g7C
                }
            },
            ...
            {
                className: "dt-head-center",
                title: appTableV1.g1Ag1B,
                name: 'g1Ag1B',
                data: 'g1B',
                render: (_, __, row) => {
                    return row.g1A + ' - ' + row.g1B
                }
            },
            ...
            {
                className: "dt-head-center",
                title: appTableV1.g8Code2,
                name: 'g8Code2',
                data: 'g8Code2',
                render: data => {
                    return data.replace(/^(\d{3})(\d{3})(\d{3})(\d{3})(\d{2}).*/, '$1 $2 $3 $4 $5');
                }
            },
            {
                className: "dt-head-center", title: appTableV1.g33, name: 'g33', data: 'g33', render: data => {
                    return data.replace(/^(\d{4})(\d{2})(\d{3})(\d{1}).*/, '$1 $2 $3 $4');
                }
            },
            {
                className: "dt-head-center nowrap g31Wi",
                searchable: false,
                title: appTableV1.g31Name,
                name: 'g31Name',
                width: '500px!important',
                data: 'g31Name',
                render: data => {
                    return '<textarea rows="1" class="border-0 font-weight-normal m-0 p-0 g31Name" style="background-color: rgb(0, 0, 0, 0); overflow:visible">' + data + '</textarea>'
                },
                orderable: false
            },
            ...
            {
                className: "dt-head-center",
                title: appTableV1.g20Ag20B,
                name: 'g20Ag20B',
                data: 'g20Name',
                render: (_, __, row) => {
                    return row.g20A + ' - ' + row.g20B
                }
            },
            {className: "dt-head-center", title: appTableV1.g22A, name: 'g22A', data: 'g22A'},
            {
                className: "dt-head-center",
                title: appTableV1.g45,
                name: 'g45',
                data: 'g45',
            ...
            {
                className: "dt-head-center", title: appTableV1.g43, name: 'g43', data: 'g43', render: data => {
                    if (data === 1) {
                        return '<span class="text-primary">' + appTableV1.oblYes + '</span>'
                    } else {
                        return '<span class="text-danger">' + appTableV1.oblNo + '</span>'
                    }
                }
            },
            {
                className: "dt-head-center",
                title: appTableV1.g31Amount,
                name: 'g31Amount',
                data: 'g31Amount',
                render: $.fn.dataTable.render.number(' ', ',', 3)
            },
            ...
            {
                className: "dt-head-center", title: appTableV1.metod, name: 'metod', data: 'metod', render: data => {
                    return data + '-' + appTableV1.methodText
                }
            },
            {
                className: "dt-head-center",
                title: appTableV1.vzaimosvyaz,
                name: 'vzaimosvyaz',
                data: 'vzaimosvyaz',
                render: data => {
                    if (data === 1) {
            ...
            {
                className: "dt-head-center", title: appTableV1.obl, name: 'obl', data: 'obl', render: data => {
                    if (data === 1) {
                        return '<span class="text-primary">' + appTableV1.oblYes + '</span>'
                    } else {
                        return '<span class="text-danger">' + appTableV1.oblNo + '</span>'
            ...
            {
                className: "dt-head-center", title: appTableV1.ktd, name: 'ktd', data: 'ktd', render: data => {
                    if (data === 1) {
                        return '<span class="text-primary">' + appTableV1.oblYes + '</span>'
                    } else {
                        return '<span class="text-danger">' + appTableV1.oblNo + '</span>'
