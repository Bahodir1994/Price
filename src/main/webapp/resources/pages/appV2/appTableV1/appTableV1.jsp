    ...
    <script>
        ...
        var app_table_01 = $('#app_table_01').DataTable({
            ...
            columns: [
                ...
                {className: "dt-head-center", title: appTableV1.g45, name: 'g45', data: 'g45', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.g45Usd, name: 'g45Usd', data: 'g45Usd', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.g42, name: 'g42', data: 'g42', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.g42Usd, name: 'g42Usd', data: 'g42Usd', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.indxusd, name: 'indxusd', data: 'indxusd', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.indxusdLn, name: 'indxusdLn', data: 'indxusdLn'},
                {className: "dt-head-center", title: appTableV1.g45Usded, name: 'g45Usded', data: 'g45Usded', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                ...
                {className: "dt-head-center", title: appTableV1.vesEd, name: 'vesEd', data: 'vesEd', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                ...
                {className: "dt-head-center", title: appTableV1.lgot20, name: 'lgot20', data: 'lgot20', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.lgot27, name: 'lgot27', data: 'lgot27', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.lgot29, name: 'lgot29', data: 'lgot29', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
                {className: "dt-head-center", title: appTableV1.sovstavka, name: 'sovstavka', data: 'sovstavka', render: $.fn.dataTable.render.number( ' ', ',', 2 )},
