!function (t, e) {
    ...
    var t = {
        362: (t, e, i) => {
                    ...
                    return void 0 === t && (t = {}), {
                        name: "autoPlacement", options: t, async fn(e) {
                            ...
                            const T = A.slice().sort(((t, e) => t.overflows[0] - e.overflows[0])),
                                ...
                                }))) ? void 0 : l.placement, M = null != R ? R : T[0].placement;
            ...
            function N(t) {
                const e = /firefox/i.test(j()), i = M(t);
            ...
            function Q(t, e, i) {
                const n = z(e), o = Z(e), r = J(t, n && function (t) {
                    const e = J(t);
                    return $(e.width) !== t.offsetWidth || $(e.height) !== t.offsetHeight
                }(e), "fixed" === i);
                let s = {scrollLeft: 0, scrollTop: 0};
                const a = {x: 0, y: 0};
                if (n || !n && "fixed" !== i) if (("body" !== H(e) || F(o)) && (s = U(e)), z(e)) {
                    const t = J(e, !0);
            ...
            function rt(t, e) {
                ...
                const n = ot(t), o = n === (null == (i = t.ownerDocument) ? void 0 : i.body), r = R(n),
                    s = o ? [r].concat(r.visualViewport || [], F(n) ? n : []) : n, a = e.concat(s);
                return o ? a : a.concat(rt(s))
            }

            function st(t, e, i) {
                return "viewport" === e ? c(function (t, e) {
                    const i = R(t), n = Z(t), o = i.visualViewport;
                    ...
                    const i = J(t, !1, "fixed" === e), n = i.top + t.clientTop, o = i.left + t.clientLeft;
                    return {
                        top: n,
                        left: o,
                        x: o,
                    ...
                    var e;
                    const i = Z(t), n = U(t), o = null == (e = t.ownerDocument) ? void 0 : e.body,
            ...
            const lt = {
                ...
                }, isElement: W, getDimensions: nt, getOffsetParent: it, getDocumentElement: Z, getElementRects: t => {
