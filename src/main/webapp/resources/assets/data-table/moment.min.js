!function (e, t) {
    ...
    function y(e) {
        if (null == e._isValid) {
            var t = _(e), n = g.call(t.parsedDateParts, function (e) {
                    return null != e
                }),
    ...
    var g = Array.prototype.some || function (e) {
        ...
        return !1
    }, w = c.momentProperties = [], t = !1;

    function p(e, t) {
        var n, s, i, r = w.length;
        if (l(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), l(t._i) || (e._i = t._i), l(t._f) || (e._f = t._f), l(t._l) || (e._l = t._l), l(t._strict) || (e._strict = t._strict), l(t._tzm) || (e._tzm = t._tzm), l(t._isUTC) || (e._isUTC = t._isUTC), l(t._offset) || (e._offset = t._offset), l(t._pf) || (e._pf = _(t)), l(t._locale) || (e._locale = t._locale), 0 < r) for (n = 0; n < r; n++) l(i = t[s = w[n]]) || (e[s] = i);
        return e
    }
    ...
    var B = /\d/, J = /\d\d/, Q = /\d{3}/, X = /\d{4}/, K = /[+-]?\d{6}/, ee = /\d\d?/, te = /\d\d\d\d?/,
        ne = /\d\d\d\d\d\d?/, se = /\d{1,3}/, ie = /\d{1,4}/, re = /[+-]?\d{1,6}/, ae = /\d+/, oe = /[+-]?\d+/,
        ue = /Z|[+-]\d\d:?\d\d/gi, le = /Z|[+-]\d\d(?::?\d\d)?/gi,
    ...
    var ze = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
        $e = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), qe = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Be = he, Je = he,
        Qe = he;
    ...
    function Mt(e) {
        ...
        if (u) {
            for (_(e).iso = !0, t = 0, n = l; t < n; t++) if (gt[t][1].exec(u[1])) {
                i = gt[t][0], s = !1 !== gt[t][2];
                break
            }
            if (null != i) {
                if (u[3]) {
                    for (t = 0, n = o; t < n; t++) if (wt[t][1].exec(u[3])) {
                        r = (u[2] || " ") + wt[t][0];
                        break
                    }
    ...
    function Ut(e) {
        var t = G(e), n = t.year || 0, s = t.quarter || 0, i = t.month || 0, r = t.week || t.isoWeek || 0,
            a = t.day || 0, o = t.hour || 0, u = t.minute || 0, l = t.second || 0, e = t.millisecond || 0;
        this._isValid = function (e) {
            var t, n, s = !1, i = Ct.length;
            for (t in e) if (f(e, t) && (-1 === we.call(Ct, t) || null != e[t] && isNaN(e[t]))) return !1;
            for (n = 0; n < i; ++n) if (e[Ct[n]]) {
                if (s) return !1;
    ...
    function Jt(e, t, n, s) {
        var i = t._milliseconds, r = Ft(t._days), t = Ft(t._months);
    ...
    var Qt = Bt(1, "add"), he = Bt(-1, "subtract");
    ...
    ie.add = Qt, ie.calendar = function (e, t) {
        ...
        var n = e || Nt(), e = Et(n, this).startOf("day"), e = c.calendarFormat(this, e) || "sameElse",
        ...
        }(e = G(e)), s = n.length, i = 0; i < s; i++) this[n[i].unit](e[n[i].unit]); else if (Y(this[e = V(e)])) return this[e](t);
        return this
        ...
        for (var e, t, n = this.localeData().eras(), s = 0, i = n.length; s < i; ++s) if (e = n[s].since <= n[s].until ? 1 : -1, t = this.clone().startOf("day").valueOf(), n[s].since <= t && t <= n[s].until || n[s].until <= t && t <= n[s].since) return (this.year() - c(n[s].since).year()) * e + n[s].offset;
        return this.year()
    ...
    function bn(e, t, n, s) {
        var i = zt(e).abs(), r = Yn(i.as("s")), a = Yn(i.as("m")), o = Yn(i.as("h")), u = Yn(i.as("d")),
